# Hoval CAN — Full Audit, ICS Deployment Quality (v0.2.3)

Cumulative audit across v0.2.1 → v0.2.3. Focus: failure modes, resource
...
- Alarm on `binary_sensor.hoval_can_gateway_connection` = off beyond a short
  grace, or `last_data_age_seconds` over your tolerance, or a rising
  `framing_errors`.
